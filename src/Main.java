...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (!userFilePathInput.equals("Q")) {
            FileStats fileStats = null;
            System.out.println("Give me a file path that you want stats on, if you wish to exit enter Q.");
            userFilePathInput = scanner.nextLine();
            Path userFilePath = Paths.get(userFilePathInput.trim());
            ...
            System.out.println("Would you like to skip whitespace? Enter true or false");
            ...
            try {
                ...
                fileStats = new FileStats(userFile, skipWs);
                 ...
                 */
                System.out.println("Stats: lines - "+ fileStats.getNumLines() + ", words - " + fileStats.getNumWords() + ", chars - " + fileStats.getNumChars() + " " + fileStats.getFileName());
            } catch (IOException e) {
